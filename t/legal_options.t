...
sub do_weave {
  ...
  # Create the mocked Dist::Zilla object
  my $zilla = Test::MockObject->new;
  my $file1 = Test::MockObject->new;
  my $file2 = Test::MockObject->new;
  $zilla->mock( 'files', sub {
    return [ $file2, $file1 ];
  } );
  $file1->set_always( 'name', 'LICENSE' );
  $file2->set_always( 'name', 'lib/MyFile.pm' );
